...
\begin{itemize}
    ...
    \item Implemented a user-space Python agent with real-time entropy calculation, frequency analysis, and a configurable mitigation loop supporting \texttt{SIGSTOP} (suspend), \texttt{SIGKILL} (terminate), and simulation modes, as well as automated filesystem snapshot triggers.
    ...
    \item Developed a comprehensive unit test suite (114 tests) covering all detection heuristics and false-positive reduction mechanisms.
\end{itemize}
