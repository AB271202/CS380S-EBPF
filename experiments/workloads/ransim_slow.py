...
def main() -> int:
    parser = argparse.ArgumentParser(description="Slow ransomware behavior simulator")
    parser.parse_args()

    set_comm(b"ransim_slw")
    build_tree()
    encrypted = encrypt_slowly()
    print(f"ransim_slw encrypted {encrypted} files slowly")
    return 0
